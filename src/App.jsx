...
const PRESETS = [
  ...
  },
  {
    ...
    type: 'strict',
    lang: 'zh',
    content: `水陸草木之花，可愛者甚蕃：晉陶淵明獨愛菊；自李唐來，世人盛愛牡丹。予獨愛蓮之出淤泥而不染，濯清漣而不妖，中通外直，不蔓不枝；香遠益清，亭亭淨植，可遠觀而不可褻玩焉。\n予謂：菊，花之隱逸者也；牡丹，花之富貴者也；蓮，花之君子者也。噫！菊之愛，陶後鮮有聞。蓮之愛，同予者何人？牡丹之愛，宜乎眾矣。`
  },
  {
    id: 'ershi',
    title: '兒時記趣 (沈復) (擷取)',
  ...
  {
    id: '114bchinesel5',
    title: '童年・夏日・棉花糖（陳幸蕙）（擷取）',
    category: 'Prose',
    type: 'strict',
    lang: 'zh',
    content: `如果，童年的回憶，是一塊如晴空一樣伸展開來的畫布，但願在那安恬如夢的世界裡，永遠有著閒適甜蜜的白雲，飄然而過。`
  },
  {
    id: '114bchinesel6',
    title: '兒童的保護傘（擷取）',
    ...
    type: 'strict',
    lang: 'zh',
    content: `兒童權利公約向兒童承諾，會盡最大的努力來保護兒童免於受到傷害。其中特別列出四大原則，包含禁止歧視、維護生命生存及發展、尊重兒少意見與考量兒童最佳利益。`
  },
  {
    id: '114bchinesel8',
    title: '我的武俠大夢（擷取）',
    ...
    type: 'strict',
    lang: 'zh',
    content: `不過比起「有夢」，我想提早讓自己有「踏實」的步驟或許更重要。夢想會改變、興趣會拓展，而在築夢的過程，練習步步踏實，踩更深、走更遠。當夢想突然出現在眼前時，就能立刻邁開大步，一手將它牢牢抓住。`
  },
  {
    id: 'shengshengman',
    title: '聲聲慢 (李清照)',
  ...
  },
  {
    ...
    type: 'strict',
    lang: 'zh',
    content: `元豐六年十月十二日夜，解衣欲睡，月色入戶，欣然起行。念無與為樂者，遂至承天寺，尋張懷民。懷民亦未寢，相與步於中庭。庭下如積水空明，水中藻、荇交橫，蓋竹柏影也。何夜無月？何處無竹柏？但少閒人如吾兩人耳。`
  },
  {
    id: 'mlk_dream',
